...
import 'cubit/states.dart';
  ...
  class ChatMessagesPost extends StatefulWidget {
  final ArgumentMessage? dataMessage;

  const ChatMessagesPost({Key? key, this.dataMessage}) : super(key: key);

  @override
  State<ChatMessagesPost> createState() => _ChatMessagesPostState();
}

class _ChatMessagesPostState extends State<ChatMessagesPost>
 ...
 */
  ...
  void initState() {
    ...
    APIs.updateMessageReadStatus(
      ...
      read: DIManager.findDep<SharedPrefs>().getUserID().toString(),type: 'post',
    );
    ...
    chatBlocFirebase.getAdsLastInfoForUserReceiver(
      ...
      user_id_2: widget.dataMessage!.user_id_2.toString() ==
          ...
          ? widget.dataMessage!.user_id.toString()
          : widget.dataMessage!.user_id_2.toString(),
      ad_id: widget.dataMessage!.ad_id.toString(), type: 'post'
    );
            ...
            child: Builder(builder: (context) {
              chatBlocFirebase.getMessages(
                  ...
                  receiverId: widget.dataMessage!.user_id_2.toString() ==
                          DIManager.findDep<SharedPrefs>().getUserID().toString()
                      ? widget.dataMessage!.user_id.toString()
                      : widget.dataMessage!.user_id_2.toString(), type: 'post');
              return BlocProvider(
                          ...
                          onTap: () {
                            navigatorToPush(
                                ...
                                pageName: PostScreen(
                                  ...
                                  idPost: int.tryParse(widget.dataMessage!.ad_id!.toString()),
                                ));
                          },
                          child: Container(
                ...
                itemBuilder: (context, messageIndex) {
                  ...
                  if (message.senderId ==
                      DIManager.findDep<SharedPrefs>()
                          .getUserID()
                          .toString()) {
                    return SenderMessageWidget(dataMessages: message,index: messageIndex,);
                  } else {
                        ...
                        children: [
                          ...
                          _isRecordingForTextFormFiled && !_isStopRecording
                            ...
                            child: Container(
                              ...
                              child: Center(
                                  child:
                                  Text(formatDuration(_recordingTime))),
                            ),
                          )
                              : _isStopRecording
                              ? Padding(
                    ...
                    _isRecordingForTextFormFiled && !_isStopRecording
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          sizeWidthNormal(),
                          InkWell(
                            onTap: isPlaying ? playRecording : stopPlaying,
                            child: Icon(
