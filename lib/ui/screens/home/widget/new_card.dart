...
class _FixedAdsItemsState extends State<FixedAdsItems> {
  ...
  Widget build(BuildContext context) {
    ...
    String? color =
    widget.dataProductItem.background_color?.replaceRange(0, 1, '0xff');
    return Padding(
      ...
      child: Align(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
              color: widget.dataProductItem.background_color == null ||
                  widget.dataProductItem.background_color == "null"
              ...
              children: [
                Column(
                  ...
                  children: [
                                ...
                                InkWell(
                                  ...
                                  child: widget.dataProductItem?.company.isEmpty
                                    ...
                                    ImageConstant.imgPerson,
                                      ...
                                      : CustomImageView(
                                    imagePath: widget.dataProductItem!
                                        .company[0].profilePic
                                        .toString()
                                        .contains('http')
                                        ? widget.dataProductItem!
                                        .company[0].profilePic
                                        .toString()
                                        : AppEndpoints
                                        .baseUrlWithoutApi +
                    ...
                    widget.dataProductItem!.city_name.toString() == "null"
                        ? Container()
                        : Row(
                      children: [
                        Container(
                          decoration: AppDecoration.outlineCompanies.copyWith(
                            color: DIManager.findDep<SharedPrefs>().getThemeApp() == 'd'?appTheme.lightBlue200: Colors.white,
                          ),
                          child: Padding(
                            padding: const EdgeInsets.only(right: 4.0, left: 16, top: 8, bottom: 8),
                            child: Row(
                              mainAxisAlignment: MainAxisAlignment.start,
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                ...
                                Text(
                                  widget.dataProductItem!.city_name
                                      .toString(),
                                  maxLines: 1,
                                  overflow: TextOverflow.ellipsis,

                                  style: themeLite.textTheme.labelMedium!
                                      .copyWith(
                                      color: appTheme.greenColor,
                                      fontSize: 12,
                                      fontWeight: FontWeight.bold),
                    ...
                    Container(
                      ...
                      child: widget.dataProductItem?.description == null
                          ? Container()
                          : Text(
                        cleanHtmlText(widget.dataProductItem!.description),
                        maxLines: widget
                            .dataProductItem!.imageNames.isEmpty ||
                    ...
                    Stack(
                      alignment: Alignment.bottomLeft,
                      children: [
                        if (widget.dataProductItem!.imageNames.isEmpty ||
                        ...
                        widget.dataProductItem.price.toString() == '0.0' ||
                          ...
                          decoration: (widget.dataProductItem!.imageNames
                              .isEmpty ||
                              widget.dataProductItem!.imageNames[0] ==
                                  null ||
                              widget.dataProductItem!.imageNames[0] ==
                                  '')
                              ? null
                              : AppDecoration.outlineButton.copyWith(
                            borderRadius: BorderRadius.circular(2),
                            color: LbeenaColors.white.withOpacity(0.92),
                            boxShadow: [],
                          ),
                          child: Padding(
                            padding: (widget.dataProductItem!.imageNames
                                .isEmpty ||
                                widget.dataProductItem!
                                    .imageNames[0] ==
                                    null ||
                            ...
                            child: Row(
                              children: [
                                if (widget.dataProductItem.finalPrice ==
                                    null) ...{
                                  Text(
                                    ...
                                    style: themeLite.textTheme.titleSmall!
                                        ...
                                        color: DIManager.findDep<
                                            ...
                                            : Colors.black,
                                        fontSize:
                                        AppFontSize.fontSize_14,
                                        fontWeight: FontWeight.w400),
                                  )
                                } else ...{
                                  double.parse(widget.dataProductItem
                                      .finalPrice
                                      .toString())
                                      .toString() ==
                                      double.parse(widget
